...
import fitnutrition.FXMLLoginController;
...
public class FXMLLoginController implements Initializable {
    ...
    private void irPrincipal(){
        try{
            ...
            Scene scenePrincipal = new Scene(FXMLLoader.load(getClass().getResource("FXMLPrincipalMedico.fxml")));
    ...
    private void irAdministrador(){
        try{
            Stage stage = (Stage) tUsuario.getScene().getWindow();
            Scene scenePrincipal = new Scene(FXMLLoader.load(getClass().getResource("FXMLPrincipalAdministrador.fxml")));
            stage.setScene(scenePrincipal);
            stage.show(); 
        }catch(IOException ex){
            Logger.getLogger(FXMLLoginController.class.getName()).log(Level.SEVERE, null, ex);

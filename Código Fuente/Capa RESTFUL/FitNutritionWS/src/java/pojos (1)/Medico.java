...
public class Medico {
    ...
    public Medico(String nombre, String apellidos, String genero, String domicilio, String num_personal, String num_cedula, String contrasena, String status, Date fecha_nacimiento) {
        this.nombre = nombre;
        this.apellidos = apellidos;
        this.genero = genero;
        this.domicilio = domicilio;
